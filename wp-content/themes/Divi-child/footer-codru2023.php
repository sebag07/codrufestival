...
<img class="footerRightImg" src="/wp-content/themes/Divi-child/images/footerright.png" alt="">
    ...
    <div class="contactSectionLeftSide container">
        ...
        <p>Fill out the form below or send us a message via email.</p>
    <?php echo do_shortcode('[wpforms id="26912" title="false"]'); ?>
    </div>
    </div>
    ...
    <div class="row m-auto justify-content-center">
        ...
        <div class="footerItems col-lg-8 col-xl-7 col-md-12 col-12">
            ...
            <span><img src="/wp-content/themes/Divi-child/images/map-pin.svg" alt="">PĂDUREA BISTRA, JUDEȚUL TIMIȘ</span>
        ...
        <div class="footerTermsMobile pt-4 d-flex justify-content-center col-md-12 col-12">
            <span><a href="/termeni-si-conditii">TERMS AND CONDITIONS</a></span>
        </div>
