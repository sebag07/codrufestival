...
<head>
    ...
    <!-- Style -->
    <link rel="stylesheet" href="/wp-content/themes/Divi-child/styleCodru2023live.css?ver=163">
    <link rel="stylesheet" href="/wp-content/themes/Divi-child/assets/css/schedule-2023.css?ver=163">
...
<body <?php post_class();?>>
    ...
    <div class="site-mobile-menu site-navbar-target">
        ...
        ?>
                ...
                <a class="heroButtonMenu" href="<?php echo get_field('ticket_button_url', 'options'); ?>"><?php echo get_field('ticket_button_text', 'options'); ?></a>
            </ul>
        </div>
