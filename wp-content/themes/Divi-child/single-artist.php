    ...
    <div class="container p-0">
        <div class="row sectionPadding">
            ...
            <div class="col-lg-4 col-md-4 col-12 artistSocialsSpotify">
                <div class="spotifyIframeContainer" style="left: 0; width: 100%; min-height:30vh; position: relative;"><?php echo get_field('spotify_iframe')?></div>
                    ...
                    <?php if ( have_rows( 'social_repeater' ) ): ?>
                        ...
                        <?php while( have_rows( 'social_repeater' ) ) : the_row(); ?>
                            ...
                            <?php if( $socialImg = get_sub_field( 'social_img' ) ) { 
                                    ...
                                    echo "<a class='col-lg-2 col-md-2 col-3 artistSocials' href='$socialURL'><img src='$socialImg' /></a>";
