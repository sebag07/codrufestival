...
<?php $filter = !empty(get_query_var('filter')) ? get_query_var('filter') : 'program' ; ?>
    <script>
                        ...
                        <?php while (have_rows('general_info_repeater', 'options')) : the_row(); ?>
                            ...
                            <?php if ($generalInfoBtnText = get_sub_field('general_info_button_text', 'options')): ?>
                                ...
                                <li class='nav-item' role='presentation'>
                                    <a class='nav-link <?php if ($filter == $generalInfoBtnUrl) echo "active"; ?>'
                                       id='pills-<?php echo $generalInfoBtnUrl; ?>-tab' data-toggle='pill'
                                       href='#pills-<?php echo $generalInfoBtnUrl; ?>' role='tab'
                                       aria-controls='pills-<?php echo $generalInfoBtnUrl; ?>'
                                       aria-selected='false'><?php echo $generalInfoBtnText; ?></a>
                                </li>
                ...
                <?php if (have_rows('general_info_repeater', 'options')): ?>
                    ...
                    <?php while (have_rows('general_info_repeater', 'options')) : the_row(); ?>
                        ...
                        <?php if ($generalInfoContent = get_sub_field('general_info_content_tab', 'options')): ?>
                            ...
                            <div class='tab-pane fade general-info-content <?php if ($filter == $generalInfoBtnUrl) echo "active show"; ?>'
                                 id='pills-<?php echo $generalInfoBtnUrl; ?>' role='tabpanel'
                                 aria-labelledby='pills-<?php echo $generalInfoBtnUrl; ?>-tab'><?php echo $generalInfoContent; ?></div>
