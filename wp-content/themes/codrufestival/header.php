...
<head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="icon" type="image/png" href="/wp-content/themes/codrufestival/images/favicon-codru.png">
    <link rel="stylesheet" href="/wp-content/themes/codrufestival/fonts/style.css">
    ...
    <!-- Style -->
    <!-- <link rel="stylesheet" href="/wp-content/themes/codrufestival/style.css?ver=173"> -->
    <link rel="stylesheet" href="/wp-content/themes/codrufestival/assets/css/schedule-2023.css?ver=174">
    ...
    <title>CODRU Festival | 27-29 august 2027, Pădurea Verde, Timișoara, Romania</title>
    ...
    $yoast_description = $queried_object_id ? get_post_meta($queried_object_id, '_yoast_wpseo_metadesc', true) : '';

    $yoast_opengraph_image = $queried_object_id ? get_post_meta($queried_object_id, '_yoast_wpseo_opengraph-image', true) : '';
...
<div class="headerHalfCircle">
    <div class="text-center"><img src="/wp-content/themes/codrufestival/images/soareclean-blue.png" alt="Soare cu sponsor principal ING"></div>
</div>
-->
