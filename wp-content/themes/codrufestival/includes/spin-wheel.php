...
function codrufestival_get_spin_wheel_props(): array
{
    ...
    return array(
        ...
        'copy' => array(
            'dates' => $text('28–30 AUGUST · PĂDUREA VERDE, TIMIȘOARA', '28–30 AUGUST · PĂDUREA VERDE, TIMIȘOARA'),
            ...
            'spinNote' => $text('🛡️ 1 învârtire de persoană', '🛡️ 1 spin per person'),
            ...
            'resultTitle' => $text('🎉 Învârtire reușită!', '🎉 Nice spin!'),
            ...
            'fomo' => $text('FOLOSEȘTE-L ÎNAINTE SĂ DISPARĂ ROATA', 'USE IT BEFORE THE WHEEL DISAPPEARS'),
