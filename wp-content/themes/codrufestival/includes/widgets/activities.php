...
function __construct(){
    $widget_ops = array( 'description' => esc_html__( 'Displays Activities', 'codrufestival' ) );
    $control_ops = array( 'width' => 400, 'height' => 300 );
    parent::__construct( false, $name = esc_html__( 'Activities Widget', 'codrufestival' ), $widget_ops, $control_ops );
}

/* Displays the Widget in the front-end */
function widget( $args, $instance ){
    extract($args);
    $title = apply_filters( 'widget_title', empty( $instance['title'] ) ? esc_html__( 'About Activities', 'codrufestival' ) : esc_html( $instance['title'] ) );
        ...
        <div class="activities-container">
            <div class="activities">
                <div class="activity active">
                    ...
                    <div class="label">
                        <div class="icon">
                            <img src="<?php echo get_template_directory_uri() . "/assets/icons/activitati/"; ?>icons-01.svg">
                        </div>
                        <div class="info">
                ...
                <div class="activity">
                    ...
                    <div class="label">
                        <div class="icon">
                            <img src="<?php echo get_template_directory_uri() . "/assets/icons/activitati/"; ?>icons-02.svg">
                        </div>
                        <div class="info">
                ...
                <div class="activity" >
                    ...
                    <div class="label">
                        <div class="icon">
                            <img src="<?php echo get_template_directory_uri() . "/assets/icons/activitati/"; ?>icons-03.svg">
                        </div>
                        <div class="info">
                ...
                <div class="activity" >
                    ...
                    <div class="label">
                        <div class="icon">
                            <img src="<?php echo get_template_directory_uri() . "/assets/icons/activitati/"; ?>icons-04.svg">
                        </div>
                        <div class="info">
                ...
                <div class="activity" >
                   ...
                   <div class="label">
                      <div class="icon">
                            <img src="<?php echo get_template_directory_uri() . "/assets/icons/activitati/"; ?>icons-05.svg">
                      </div>
                      <div class="info">
                ...
                <div class="activity" >
                    ...
                    <div class="label">
                       <div class="icon">
                            <img src="<?php echo get_template_directory_uri() . "/assets/icons/activitati/"; ?>icons-06.svg">
                       </div>
                       <div class="info">
                 ...
                 <div class="activity" >
                    ...
                    <div class="label">
                       <div class="icon">
                            <img src="<?php echo get_template_directory_uri() . "/assets/icons/activitati/"; ?>icons-07.svg">
                       </div>
                       <div class="info">
                 ...
                 <div class="activity" >
                    ...
                    <div class="label">
                       <div class="icon">
                            <img src="<?php echo get_template_directory_uri() . "/assets/icons/activitati/"; ?>icons-08.svg">
                       </div>
                       <div class="info">
...
function form( $instance ){
    //Defaults
    $instance = wp_parse_args( (array) $instance, array( 'title' => esc_html__( 'About Activities', 'codrufestival' ), 'imagePath' => '', 'aboutText' => '' ) );
