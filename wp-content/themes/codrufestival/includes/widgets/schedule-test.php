...
class scheduleTest extends WP_Widget {

function __construct(){
    $widget_ops = array( 'description' => esc_html__( 'Displays Schedule-Test Information', 'codrufestival' ) );
    $control_ops = array( 'width' => 400, 'height' => 300 );
    parent::__construct( false, $name = esc_html__( 'Schedule Test Widget', 'codrufestival' ), $widget_ops, $control_ops );
}

/* Displays the Widget in the front-end */
function widget( $args, $instance ){
    extract($args);
    $title = apply_filters( 'widget_title', empty( $instance['title'] ) ? esc_html__( 'About Schedule-Test', 'codrufestival' ) : esc_html( $instance['title'] ) );
...
<div class="cd-main-header">
    <div class="filterContainer">
      <button class="filterBtn selected" style="background-image: url('/wp-content/themes/codrufestival/assets/icons/scene/icons-01.svg');" data-value="stage1"></button>
      <button class="filterBtn" style="background-image: url('/wp-content/themes/codrufestival/assets/icons/scene/icons-04.svg');" data-value="stage2"></button>
      <button class="filterBtn" style="background-image: url('/wp-content/themes/codrufestival/assets/icons/scene/icons-03.svg');" data-value="stage3"></button>
      <button class="filterBtn" style="background-image: url('/wp-content/themes/codrufestival/assets/icons/scene/icons-02.svg');" data-value="stage4"></button>
      <button class="filterBtn" style="background-image: url('/wp-content/themes/codrufestival/assets/icons/scene/Teatru.svg');" data-value="stage5"></button>
      <button class="filterBtn" style="background-image: url('/wp-content/themes/codrufestival/assets/icons/scene/Film.svg');" data-value="stage6"></button>
  </div>
</div>
...
function form( $instance ){
    //Defaults
    $instance = wp_parse_args( (array) $instance, array( 'title' => esc_html__( 'About Schedule-Test', 'codrufestival' ), 'imagePath' => '', 'aboutText' => '' ) );
...
function load_schedule_test_widget() {
    register_widget('scheduleTest');
}
add_action('widgets_init', 'load_schedule_test_widget');