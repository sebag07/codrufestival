...
function __construct(){
    $widget_ops = array( 'description' => esc_html__( 'Displays Schedule Information', 'codrufestival' ) );
    $control_ops = array( 'width' => 400, 'height' => 300 );
    parent::__construct( false, $name = esc_html__( 'Schedule Widget', 'codrufestival' ), $widget_ops, $control_ops );
}

/* Displays the Widget in the front-end */
function widget( $args, $instance ){
    extract($args);
    $title = apply_filters( 'widget_title', empty( $instance['title'] ) ? esc_html__( 'About Schedule', 'codrufestival' ) : esc_html( $instance['title'] ) );
...
function form( $instance ){
    //Defaults
    $instance = wp_parse_args( (array) $instance, array( 'title' => esc_html__( 'About Schedule', 'codrufestival' ), 'imagePath' => '', 'aboutText' => '' ) );
