...
jQuery(function () {
    ...
    var bindSiteMenuToggle = function () {
      jQuery('body')
        .off('click.codruMenuToggle', '.js-menu-toggle')
        .on('click.codruMenuToggle', '.js-menu-toggle', function (e) {
    ...
    var siteMenuClone = function () {
      jQuery('.site-mobile-menu-body > .site-nav-wrap').remove();
      ...
      setTimeout(function () {
        ...
        jQuery('.site-mobile-menu .has-children').each(function () {
          ...
          $this.find('> .arrow-collapse').remove();
  ...
  jQuery(function () {
    jQuery('.has-children > a').on("click", function (e) {
      e.preventDefault();
    });
  });
  ...
  jQuery(window).on("load", function () {
    ...
    gallery = jQuery('.artist-gallery');
    lightbox = jQuery('.image-gallery');
    image_gallery = jQuery('.image-gallery');
