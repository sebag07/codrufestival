            ...
            foreach ($postslist as $post) : ?>
                ...
                <div class='swiper-slide'>
                    <a href='<?php echo $post->guid; ?>' class='homepageNewsLink'>
                        ...
                        <div class='homepageNewsTitle'><h3><?php echo $post->post_title; ?></h3><span><img src='/wp-content/themes/codrufestival/images/right-chevron.png' /><?php echo $read_more; ?></span></div>
                    </a>
                </div>
            <?php endforeach; ?>
        </div>
