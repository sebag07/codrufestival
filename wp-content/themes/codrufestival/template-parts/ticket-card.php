<?php
if (!isset($displayCardTitle, $displayCardPrice, $cardDescription, $cardButtonURL, $cardButtonText)) {
    return;
}

$cardReducedPrice = $cardReducedPrice ?? '';
?>
...
C277.507,355.325,273.029,350.847,267.507,350.847z'></path>
        ...
        <div class="card-description">
            <p><?php echo wp_kses_post($cardDescription); ?></p>
        </div>
        <div class="info-container">
            <div class="card-price-info">
                <?php if (!empty($cardReducedPrice)): ?>
                    <p class="stroke-price"><?php echo esc_html($cardReducedPrice); ?></p>
                <?php endif; ?>
                <p class="card-price"><?php echo esc_html($displayCardPrice); ?></p>
            </div>
            <div class="card-button">
                <a href="<?php echo esc_url($cardButtonURL); ?>" target="_blank" rel="noopener noreferrer"><?php echo esc_html($cardButtonText); ?></a>
            </div>
        </div>
    </div>
</div>
