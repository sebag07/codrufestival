...
<div class="container-fluid partnersPage m-auto">
    <div class="row valuesContainer">
        ...
        <div class="col-lg-6 col-md-8 col-12 pt-5">
            ...
            <?php
                $repeaterCounter = get_sub_field('value_number');
                    echo "<div class='valueRepeater'>
                            <p class='value-step'>$repeaterCounter</p>";
        ...
        <div class="col-lg-6 col-md-4 col-12 partnerImage">
            <img src="/wp-content/themes/codrufestival/images/rightimg.png" alt="">
        </div>
        <div class="col-lg-12 col-md-12 col-12 text-center partnersTitle valueRepeater" style="justify-content: center">
            <h2>Dacă și compania ta crede în aceste valori, contactează-ne acum!</h2>
        </div>
    </div>
</div>
